...
/* Caso d'uso tickerplan con code temporanee provato con ver broker 7.7.0*/

/* config usando divert broker.xml in /sviluppo/amq-broker/instances/amq01/etc:
* 
* 
        ...
        <diverts>
          <divert name="uc5Divert">
                <address>TICKERPLAN.TICKER</address>
                <forwarding-address>TICKERPLAN.LVQ</forwarding-address>
...
public:
    ...
    virtual void run() {
        ...
        try {
            ...
            if (useTopic) {
                destination = session->createTopic("TICKERPLAN.TICKER");
            }
            else {
